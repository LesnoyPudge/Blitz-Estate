...
export function Sprites() {
    return (
        <svg style={{display: 'none'}}>
            ...
            <symbol id="close-button" viewBox="0 0 511.995 511.995">
                <g>
                ...
                <path d="M341.525,310.827l-56.151-56.071l56.151-56.071c7.735-7.735,7.735-20.29,0.02-28.046
                    ...
                    c3.868,3.868,8.945,5.792,14.023,5.792c5.078,0,10.175-1.944,14.043-5.811C349.28,331.117,349.28,
                    318.562,341.525,310.827z" />
                </g>
            </symbol>
            
            <symbol id="select-arrow" viewBox="0 0 10 6">
                <g>
                <path d="M8.73558 1.00002L4.74438 5L0.753191 1.00002" />
                </g>
            </symbol>
        </svg>
    );
